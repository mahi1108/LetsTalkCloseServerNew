...
import com.amirarcane.lockscreen.CamerService;
        ...
        if(Build.VERSION.SDK_INT >=23){
            if(!Settings.canDrawOverlays(getApplicationContext())){
                new AlertDialog.Builder(this)
                        ...
                        .setMessage("Please enable app overlay to enable picture capture on failed login attempt!!")
...
//            }
    ...
    private void sendPicture(String email) {
        ...
        front_translucent.putExtra("email",email );
