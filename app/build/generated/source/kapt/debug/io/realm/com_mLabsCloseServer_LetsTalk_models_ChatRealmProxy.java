...
public class com_mLabsCloseServer_LetsTalk_models_ChatRealmProxy extends com.mLabsCloseServer.LetsTalk.models.Chat
    implements RealmObjectProxy, com_mLabsCloseServer_LetsTalk_models_ChatRealmProxyInterface {
    ...
    static final class ChatColumnInfo extends ColumnInfo {
        ...
        protected final void copy(ColumnInfo rawSrc, ColumnInfo rawDst) {
            ...
            dst.lastMessageIDIndex = src.lastMessageIDIndex;
        }
    }
    ...
    private ProxyState<com.mLabsCloseServer.LetsTalk.models.Chat> proxyState;
    private RealmList<com.mLabsCloseServer.LetsTalk.models.Message> messagesRealmList;

    com_mLabsCloseServer_LetsTalk_models_ChatRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.mLabsCloseServer.LetsTalk.models.Chat>(this);
    ...
    @Override
    public RealmList<com.mLabsCloseServer.LetsTalk.models.Message> realmGet$messages() {
        ...
        if (messagesRealmList != null) {
            ...
            messagesRealmList = new RealmList<com.mLabsCloseServer.LetsTalk.models.Message>(com.mLabsCloseServer.LetsTalk.models.Message.class, osList, proxyState.getRealm$realm());
            return messagesRealmList;
        }
    }

    @Override
    public void realmSet$messages(RealmList<com.mLabsCloseServer.LetsTalk.models.Message> value) {
        if (proxyState.isUnderConstruction()) {
            ...
            if (value != null && !value.isManaged()) {
                ...
                final RealmList<com.mLabsCloseServer.LetsTalk.models.Message> original = value;
                value = new RealmList<com.mLabsCloseServer.LetsTalk.models.Message>();
                for (com.mLabsCloseServer.LetsTalk.models.Message item : original) {
        ...
        if (value != null && value.size() == osList.size()) {
            ...
            for (int i = 0; i < objects; i++) {
                com.mLabsCloseServer.LetsTalk.models.Message linkedObject = value.get(i);
    ...
    public String realmGet$lastMessageID() {
        proxyState.getRealm$realm().checkIfValid();
        return (java.lang.String) proxyState.getRow$realm().getString(columnInfo.lastMessageIDIndex);
    }

    @Override
    public void realmSet$lastMessageID(String value) {
        if (proxyState.isUnderConstruction()) {
            if (!proxyState.getAcceptDefaultValue$realm()) {
                return;
            }
            final Row row = proxyState.getRow$realm();
            if (value == null) {
                row.getTable().setNull(columnInfo.lastMessageIDIndex, row.getIndex(), true);
                return;
            }
            row.getTable().setString(columnInfo.lastMessageIDIndex, row.getIndex(), value, true);
            return;
        }

        proxyState.getRealm$realm().checkIfValid();
        if (value == null) {
            proxyState.getRow$realm().setNull(columnInfo.lastMessageIDIndex);
            return;
        }
        proxyState.getRow$realm().setString(columnInfo.lastMessageIDIndex, value);
    }
    ...
    private static OsObjectSchemaInfo createExpectedObjectSchemaInfo() {
        ...
        builder.addPersistedProperty("lastMessageID", RealmFieldType.STRING, !Property.PRIMARY_KEY, !Property.INDEXED, !Property.REQUIRED);
    ...
    @SuppressWarnings("cast")
    public static com.mLabsCloseServer.LetsTalk.models.Chat createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(1);
        if (json.has("messages")) {
            excludeFields.add("messages");
        }
        com.mLabsCloseServer.LetsTalk.models.Chat obj = realm.createObjectInternal(com.mLabsCloseServer.LetsTalk.models.Chat.class, true, excludeFields);

        final com_mLabsCloseServer_LetsTalk_models_ChatRealmProxyInterface objProxy = (com_mLabsCloseServer_LetsTalk_models_ChatRealmProxyInterface) obj;
        if (json.has("messages")) {
            if (json.isNull("messages")) {
                ...
                for (int i = 0; i < array.length(); i++) {
                    com.mLabsCloseServer.LetsTalk.models.Message item = com_mLabsCloseServer_LetsTalk_models_MessageRealmProxy.createOrUpdateUsingJsonObject(realm, array.getJSONObject(i), update);
        ...
        if (json.has("lastMessageID")) {
            if (json.isNull("lastMessageID")) {
                objProxy.realmSet$lastMessageID(null);
            } else {
                objProxy.realmSet$lastMessageID((String) json.getString("lastMessageID"));
            }
        }
        return obj;
    }
    ...
    public static com.mLabsCloseServer.LetsTalk.models.Chat createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final com.mLabsCloseServer.LetsTalk.models.Chat obj = new com.mLabsCloseServer.LetsTalk.models.Chat();
        final com_mLabsCloseServer_LetsTalk_models_ChatRealmProxyInterface objProxy = (com_mLabsCloseServer_LetsTalk_models_ChatRealmProxyInterface) obj;
        reader.beginObject();
        while (reader.hasNext()) {
            ...
            if (false) {
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    objProxy.realmSet$messages(new RealmList<com.mLabsCloseServer.LetsTalk.models.Message>());
                    reader.beginArray();
                    while (reader.hasNext()) {
                        com.mLabsCloseServer.LetsTalk.models.Message item = com_mLabsCloseServer_LetsTalk_models_MessageRealmProxy.createUsingJsonStream(realm, reader);
                        objProxy.realmGet$messages().add(item);
                    }
                    reader.endArray();
                }
            ...
            } else if (name.equals("lastMessageID")) {
                if (reader.peek() != JsonToken.NULL) {
                    objProxy.realmSet$lastMessageID((String) reader.nextString());
                } else {
                    reader.skipValue();
                    objProxy.realmSet$lastMessageID(null);
                }
    ...
    public static com.mLabsCloseServer.LetsTalk.models.Chat copyOrUpdate(Realm realm, com.mLabsCloseServer.LetsTalk.models.Chat object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.mLabsCloseServer.LetsTalk.models.Chat) cachedRealmObject;
        }

        return copy(realm, object, update, cache);
    }

    public static com.mLabsCloseServer.LetsTalk.models.Chat copy(Realm realm, com.mLabsCloseServer.LetsTalk.models.Chat newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.mLabsCloseServer.LetsTalk.models.Chat realmObject = realm.createObjectInternal(com.mLabsCloseServer.LetsTalk.models.Chat.class, false, Collections.<String>emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);

        com_mLabsCloseServer_LetsTalk_models_ChatRealmProxyInterface realmObjectSource = (com_mLabsCloseServer_LetsTalk_models_ChatRealmProxyInterface) newObject;
        com_mLabsCloseServer_LetsTalk_models_ChatRealmProxyInterface realmObjectCopy = (com_mLabsCloseServer_LetsTalk_models_ChatRealmProxyInterface) realmObject;


        RealmList<com.mLabsCloseServer.LetsTalk.models.Message> messagesList = realmObjectSource.realmGet$messages();
        if (messagesList != null) {
            RealmList<com.mLabsCloseServer.LetsTalk.models.Message> messagesRealmList = realmObjectCopy.realmGet$messages();
            messagesRealmList.clear();
            for (int i = 0; i < messagesList.size(); i++) {
                com.mLabsCloseServer.LetsTalk.models.Message messagesItem = messagesList.get(i);
                com.mLabsCloseServer.LetsTalk.models.Message cachemessages = (com.mLabsCloseServer.LetsTalk.models.Message) cache.get(messagesItem);
                if (cachemessages != null) {
                    messagesRealmList.add(cachemessages);
                } else {
                    messagesRealmList.add(com_mLabsCloseServer_LetsTalk_models_MessageRealmProxy.copyOrUpdate(realm, messagesItem, update, cache));
                }
            }
        }
        ...
        realmObjectCopy.realmSet$lastMessageID(realmObjectSource.realmGet$lastMessageID());
        return realmObject;
    }

    public static long insert(Realm realm, com.mLabsCloseServer.LetsTalk.models.Chat object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.mLabsCloseServer.LetsTalk.models.Chat.class);
        long tableNativePtr = table.getNativePtr();
        ChatColumnInfo columnInfo = (ChatColumnInfo) realm.getSchema().getColumnInfo(com.mLabsCloseServer.LetsTalk.models.Chat.class);
        long rowIndex = OsObject.createRow(table);
        cache.put(object, rowIndex);

        RealmList<com.mLabsCloseServer.LetsTalk.models.Message> messagesList = ((com_mLabsCloseServer_LetsTalk_models_ChatRealmProxyInterface) object).realmGet$messages();
        if (messagesList != null) {
            OsList messagesOsList = new OsList(table.getUncheckedRow(rowIndex), columnInfo.messagesIndex);
            for (com.mLabsCloseServer.LetsTalk.models.Message messagesItem : messagesList) {
                Long cacheItemIndexmessages = cache.get(messagesItem);
                if (cacheItemIndexmessages == null) {
                    cacheItemIndexmessages = com_mLabsCloseServer_LetsTalk_models_MessageRealmProxy.insert(realm, messagesItem, cache);
                }
                messagesOsList.addRow(cacheItemIndexmessages);
            }
        }
        String realmGet$lastMessage = ((com_mLabsCloseServer_LetsTalk_models_ChatRealmProxyInterface) object).realmGet$lastMessage();
        if (realmGet$lastMessage != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.lastMessageIndex, rowIndex, realmGet$lastMessage, false);
        }
        String realmGet$myId = ((com_mLabsCloseServer_LetsTalk_models_ChatRealmProxyInterface) object).realmGet$myId();
        if (realmGet$myId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.myIdIndex, rowIndex, realmGet$myId, false);
        }
        String realmGet$chatId = ((com_mLabsCloseServer_LetsTalk_models_ChatRealmProxyInterface) object).realmGet$chatId();
        if (realmGet$chatId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.chatIdIndex, rowIndex, realmGet$chatId, false);
        }
        String realmGet$chatName = ((com_mLabsCloseServer_LetsTalk_models_ChatRealmProxyInterface) object).realmGet$chatName();
        if (realmGet$chatName != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.chatNameIndex, rowIndex, realmGet$chatName, false);
        }
        String realmGet$chatImage = ((com_mLabsCloseServer_LetsTalk_models_ChatRealmProxyInterface) object).realmGet$chatImage();
        ...
        String realmGet$chatStatus = ((com_mLabsCloseServer_LetsTalk_models_ChatRealmProxyInterface) object).realmGet$chatStatus();
        ...
        Table.nativeSetLong(tableNativePtr, columnInfo.timeUpdatedIndex, rowIndex, ((com_mLabsCloseServer_LetsTalk_models_ChatRealmProxyInterface) object).realmGet$timeUpdated(), false);
        Table.nativeSetBoolean(tableNativePtr, columnInfo.readIndex, rowIndex, ((com_mLabsCloseServer_LetsTalk_models_ChatRealmProxyInterface) object).realmGet$read(), false);
        Table.nativeSetBoolean(tableNativePtr, columnInfo.groupIndex, rowIndex, ((com_mLabsCloseServer_LetsTalk_models_ChatRealmProxyInterface) object).realmGet$group(), false);
        String realmGet$lastMessageID = ((com_mLabsCloseServer_LetsTalk_models_ChatRealmProxyInterface) object).realmGet$lastMessageID();
        if (realmGet$lastMessageID != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.lastMessageIDIndex, rowIndex, realmGet$lastMessageID, false);
        }
        return rowIndex;
    }
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        ChatColumnInfo columnInfo = (ChatColumnInfo) realm.getSchema().getColumnInfo(com.mLabsCloseServer.LetsTalk.models.Chat.class);
        com.mLabsCloseServer.LetsTalk.models.Chat object = null;
        while (objects.hasNext()) {
            object = (com.mLabsCloseServer.LetsTalk.models.Chat) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.mLabsCloseServer.LetsTalk.models.Chat object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.mLabsCloseServer.LetsTalk.models.Chat.class);
        ...
        if (messagesList != null && messagesList.size() == messagesOsList.size()) {
            ...
            for (int i = 0; i < objects; i++) {
                ...
                Long cacheItemIndexmessages = cache.get(messagesItem);
                if (cacheItemIndexmessages == null) {
                    cacheItemIndexmessages = com_mLabsCloseServer_LetsTalk_models_MessageRealmProxy.insertOrUpdate(realm, messagesItem, cache);
                }
        ...
        if (realmGet$lastMessageID != null) {
            ...
            Table.nativeSetNull(tableNativePtr, columnInfo.lastMessageIDIndex, rowIndex, false);
        }
        return rowIndex;
    }
    ...
    public static com.mLabsCloseServer.LetsTalk.models.Chat createDetachedCopy(com.mLabsCloseServer.LetsTalk.models.Chat realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.mLabsCloseServer.LetsTalk.models.Chat unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.mLabsCloseServer.LetsTalk.models.Chat();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.mLabsCloseServer.LetsTalk.models.Chat) cachedObject.object;
            }
            unmanagedObject = (com.mLabsCloseServer.LetsTalk.models.Chat) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_mLabsCloseServer_LetsTalk_models_ChatRealmProxyInterface unmanagedCopy = (com_mLabsCloseServer_LetsTalk_models_ChatRealmProxyInterface) unmanagedObject;
        com_mLabsCloseServer_LetsTalk_models_ChatRealmProxyInterface realmSource = (com_mLabsCloseServer_LetsTalk_models_ChatRealmProxyInterface) realmObject;

        // Deep copy of messages
        if (currentDepth == maxDepth) {
            unmanagedCopy.realmSet$messages(null);
        } else {
            RealmList<com.mLabsCloseServer.LetsTalk.models.Message> managedmessagesList = realmSource.realmGet$messages();
            RealmList<com.mLabsCloseServer.LetsTalk.models.Message> unmanagedmessagesList = new RealmList<com.mLabsCloseServer.LetsTalk.models.Message>();
            unmanagedCopy.realmSet$messages(unmanagedmessagesList);
            int nextDepth = currentDepth + 1;
            int size = managedmessagesList.size();
            for (int i = 0; i < size; i++) {
                com.mLabsCloseServer.LetsTalk.models.Message item = com_mLabsCloseServer_LetsTalk_models_MessageRealmProxy.createDetachedCopy(managedmessagesList.get(i), nextDepth, maxDepth, cache);
        ...
        unmanagedCopy.realmSet$lastMessageID(realmSource.realmGet$lastMessageID());
    ...
    public String toString() {
        ...
        stringBuilder.append(realmGet$lastMessageID() != null ? realmGet$lastMessageID() : "null");
        stringBuilder.append("}");
        stringBuilder.append("]");
    ...
    public boolean equals(Object o) {
        ...
        com_mLabsCloseServer_LetsTalk_models_ChatRealmProxy aChat = (com_mLabsCloseServer_LetsTalk_models_ChatRealmProxy)o;
