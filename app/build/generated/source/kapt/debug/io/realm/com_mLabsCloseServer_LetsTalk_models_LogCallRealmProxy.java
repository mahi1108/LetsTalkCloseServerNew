...
public class com_mLabsCloseServer_LetsTalk_models_LogCallRealmProxy extends com.mLabsCloseServer.LetsTalk.models.LogCall
    implements RealmObjectProxy, com_mLabsCloseServer_LetsTalk_models_LogCallRealmProxyInterface {
    ...
    private ProxyState<com.mLabsCloseServer.LetsTalk.models.LogCall> proxyState;

    com_mLabsCloseServer_LetsTalk_models_LogCallRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.mLabsCloseServer.LetsTalk.models.LogCall>(this);
    ...
    @SuppressWarnings("cast")
    public static com.mLabsCloseServer.LetsTalk.models.LogCall createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.mLabsCloseServer.LetsTalk.models.LogCall obj = realm.createObjectInternal(com.mLabsCloseServer.LetsTalk.models.LogCall.class, true, excludeFields);

        final com_mLabsCloseServer_LetsTalk_models_LogCallRealmProxyInterface objProxy = (com_mLabsCloseServer_LetsTalk_models_LogCallRealmProxyInterface) obj;
    ...
    public static com.mLabsCloseServer.LetsTalk.models.LogCall createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final com.mLabsCloseServer.LetsTalk.models.LogCall obj = new com.mLabsCloseServer.LetsTalk.models.LogCall();
        final com_mLabsCloseServer_LetsTalk_models_LogCallRealmProxyInterface objProxy = (com_mLabsCloseServer_LetsTalk_models_LogCallRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.mLabsCloseServer.LetsTalk.models.LogCall copyOrUpdate(Realm realm, com.mLabsCloseServer.LetsTalk.models.LogCall object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.mLabsCloseServer.LetsTalk.models.LogCall) cachedRealmObject;
        }

        return copy(realm, object, update, cache);
    }

    public static com.mLabsCloseServer.LetsTalk.models.LogCall copy(Realm realm, com.mLabsCloseServer.LetsTalk.models.LogCall newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.mLabsCloseServer.LetsTalk.models.LogCall realmObject = realm.createObjectInternal(com.mLabsCloseServer.LetsTalk.models.LogCall.class, false, Collections.<String>emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);

        com_mLabsCloseServer_LetsTalk_models_LogCallRealmProxyInterface realmObjectSource = (com_mLabsCloseServer_LetsTalk_models_LogCallRealmProxyInterface) newObject;
        com_mLabsCloseServer_LetsTalk_models_LogCallRealmProxyInterface realmObjectCopy = (com_mLabsCloseServer_LetsTalk_models_LogCallRealmProxyInterface) realmObject;
    ...
    public static long insert(Realm realm, com.mLabsCloseServer.LetsTalk.models.LogCall object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.mLabsCloseServer.LetsTalk.models.LogCall.class);
        long tableNativePtr = table.getNativePtr();
        LogCallColumnInfo columnInfo = (LogCallColumnInfo) realm.getSchema().getColumnInfo(com.mLabsCloseServer.LetsTalk.models.LogCall.class);
        long rowIndex = OsObject.createRow(table);
        cache.put(object, rowIndex);
        Table.nativeSetLong(tableNativePtr, columnInfo.timeUpdatedIndex, rowIndex, ((com_mLabsCloseServer_LetsTalk_models_LogCallRealmProxyInterface) object).realmGet$timeUpdated(), false);
        Table.nativeSetLong(tableNativePtr, columnInfo.timeDurationSecondsIndex, rowIndex, ((com_mLabsCloseServer_LetsTalk_models_LogCallRealmProxyInterface) object).realmGet$timeDurationSeconds(), false);
        String realmGet$status = ((com_mLabsCloseServer_LetsTalk_models_LogCallRealmProxyInterface) object).realmGet$status();
        if (realmGet$status != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.statusIndex, rowIndex, realmGet$status, false);
        }
        String realmGet$myId = ((com_mLabsCloseServer_LetsTalk_models_LogCallRealmProxyInterface) object).realmGet$myId();
        if (realmGet$myId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.myIdIndex, rowIndex, realmGet$myId, false);
        }
        String realmGet$userId = ((com_mLabsCloseServer_LetsTalk_models_LogCallRealmProxyInterface) object).realmGet$userId();
        if (realmGet$userId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.userIdIndex, rowIndex, realmGet$userId, false);
        }
        String realmGet$userName = ((com_mLabsCloseServer_LetsTalk_models_LogCallRealmProxyInterface) object).realmGet$userName();
        if (realmGet$userName != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.userNameIndex, rowIndex, realmGet$userName, false);
        }
        String realmGet$userImage = ((com_mLabsCloseServer_LetsTalk_models_LogCallRealmProxyInterface) object).realmGet$userImage();
        ...
        String realmGet$userStatus = ((com_mLabsCloseServer_LetsTalk_models_LogCallRealmProxyInterface) object).realmGet$userStatus();
        ...
        Table.nativeSetBoolean(tableNativePtr, columnInfo.isVideoIndex, rowIndex, ((com_mLabsCloseServer_LetsTalk_models_LogCallRealmProxyInterface) object).realmGet$isVideo(), false);
        return rowIndex;
    }
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        LogCallColumnInfo columnInfo = (LogCallColumnInfo) realm.getSchema().getColumnInfo(com.mLabsCloseServer.LetsTalk.models.LogCall.class);
        com.mLabsCloseServer.LetsTalk.models.LogCall object = null;
        while (objects.hasNext()) {
            object = (com.mLabsCloseServer.LetsTalk.models.LogCall) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.mLabsCloseServer.LetsTalk.models.LogCall object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.mLabsCloseServer.LetsTalk.models.LogCall.class);
    ...
    public static com.mLabsCloseServer.LetsTalk.models.LogCall createDetachedCopy(com.mLabsCloseServer.LetsTalk.models.LogCall realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.mLabsCloseServer.LetsTalk.models.LogCall unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.mLabsCloseServer.LetsTalk.models.LogCall();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.mLabsCloseServer.LetsTalk.models.LogCall) cachedObject.object;
            }
            unmanagedObject = (com.mLabsCloseServer.LetsTalk.models.LogCall) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_mLabsCloseServer_LetsTalk_models_LogCallRealmProxyInterface unmanagedCopy = (com_mLabsCloseServer_LetsTalk_models_LogCallRealmProxyInterface) unmanagedObject;
        com_mLabsCloseServer_LetsTalk_models_LogCallRealmProxyInterface realmSource = (com_mLabsCloseServer_LetsTalk_models_LogCallRealmProxyInterface) realmObject;
    ...
    public boolean equals(Object o) {
        ...
        com_mLabsCloseServer_LetsTalk_models_LogCallRealmProxy aLogCall = (com_mLabsCloseServer_LetsTalk_models_LogCallRealmProxy)o;
