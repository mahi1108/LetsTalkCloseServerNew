...
import com.mLabsCloseServer.LetsTalk.activities.ImageViewerActivity;
...
import com.mLabsCloseServer.LetsTalk.utils.MyFileProvider;
        ...
        public void setData(Message msg) {
            ...
            switch (msg.getAttachmentType()) {
                case AttachmentTypes.IMAGE:
                    ...
                    Glide.with(context).load(msg.getAttachment().getUrl()).apply(new RequestOptions().placeholder(R.drawable.letstalk_placeholder)).into(imageView);
                    break;
