        ...
        this.filter = new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                /*
                    ...
                    if (dataList.get(-1).isInviteAble()) dataListFiltered = dataList;
                    else dataListFiltered = dataList;
             ...
             */
                    ...
                    for (User row : dataList) {
                        ...
                        String CheckWith = row.getName() != null ? row.getName() : row.getName();

                        boolean chek = row.isInviteAble();
                        if (toCheckWith.toLowerCase().startsWith(charString.toLowerCase()) && chek == true) {
                        ...
                        /*
                        if (chek==true &&CheckWith.toLowerCase().startsWith(charString.toLowerCase()) ){
                           filteredList.add(row);
                        ...
                        */
                        ...
                        //String CheckWith =row.getName() !=null && row.isInviteAble() :row.getName();
...
*/
    ...
    class UsersViewHolder extends BaseViewHolder {
        ...
        public void setData(User user) {
            ...
            Glide.with(context).load(user.getImage()).apply(new RequestOptions().placeholder(R.drawable.letstalk_placeholder)).into(userImage);
