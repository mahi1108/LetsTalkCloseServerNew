...
public class Message implements Parcelable, RealmModel {
    ...
    private RealmList<com.mLabsCloseServer.LetsTalk.models.MyString> recipientGroupIds;
    private long date;
    ...
    public RealmList<com.mLabsCloseServer.LetsTalk.models.MyString> getRecipientGroupIds() {
        return recipientGroupIds;
    }

    public void setRecipientGroupIds(ArrayList<com.mLabsCloseServer.LetsTalk.models.MyString> recipientGroupIds) {
