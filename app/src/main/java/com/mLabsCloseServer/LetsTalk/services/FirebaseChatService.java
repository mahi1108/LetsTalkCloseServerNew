package com.mLabsCloseServer.LetsTalk.services;
...
import com.mLabsCloseServer.LetsTalk.activities.ChatActivity;
...
import com.mLabsCloseServer.LetsTalk.utils.FirebaseUploader;
...
public class FirebaseChatService extends Service {
    ...
    public void onCreate() {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            NotificationChannel channel = new NotificationChannel(CHANNEL_ID_MAIN, "lets talk chat service", NotificationManager.IMPORTANCE_LOW);
...
*/
    ...
    private void notifyNewGroup(Group group) {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            NotificationChannel channel = new NotificationChannel(CHANNEL_ID_GROUP, "lets talk new group notification", NotificationManager.IMPORTANCE_DEFAULT);
    ...
    private void saveMessage(Message message) {
        ...
        if (!message.isDelivered() && !message.getSenderId().equals(myId) && !helper.isUserMute(message.getSenderId()) && (Helper.CURRENT_CHAT_ID == null || !Helper.CURRENT_CHAT_ID.equals(userOrGroupId))) {
            ...
            if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
                NotificationChannel channel = new NotificationChannel(channelId, "lets talk new message notification", NotificationManager.IMPORTANCE_DEFAULT);
                notificationManager.createNotificationChannel(channel);
            ...
            try {
                ...
                text = cryptLib.decryptCipherTextWithRandomIV(message.getBody(), message.getId());
