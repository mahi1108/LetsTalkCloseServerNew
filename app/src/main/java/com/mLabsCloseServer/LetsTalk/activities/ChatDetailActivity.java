...
import com.mLabsCloseServer.LetsTalk.fragments.ChatDetailFragment;
import com.mLabsCloseServer.LetsTalk.fragments.UserMediaFragment;
import com.mLabsCloseServer.LetsTalk.interfaces.OnUserDetailFragmentInteraction;
...
public class ChatDetailActivity extends BaseActivity implements OnUserDetailFragmentInteraction, ImagePickerCallback {
    ...
    private void setUserData() {
        ...
        Glide.with(this).load(user != null ? user.getImage() : group.getImage()).apply(new RequestOptions().placeholder(R.drawable.letstalk_placeholder)).into(userImage);
