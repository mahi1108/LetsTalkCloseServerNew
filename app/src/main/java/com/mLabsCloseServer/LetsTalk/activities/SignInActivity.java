...
import com.mLabsCloseServer.LetsTalk.serverType.CloseServerReg;
...
public class SignInActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //} else if (user == null) {
            //startActivity(new Intent(SignInActivity.this, CloseServerReg.class));
       ...
       if(getIntent().getStringExtra("selectedOrg") != null)
       {
           organization_name = getIntent().getStringExtra("selectedOrg");
       }

        if(getIntent().getStringExtra("selectedDept") != null)
        {
            dept_name = getIntent().getStringExtra("selectedDept");
        }
                ...
                if (dataSnapshot.exists() && dataSnapshot.getChildrenCount() > 0) {
                    try {
                        ...
                        if (User.validate(user)) {
                            ...
                            createUser(new User(dept_name,phoneNumberInPrefs, phoneNumberInPrefs, getString(R.string.app_name), "",false,false,reg_user_name,organization_name));
                        }
                    } catch (Exception ex) {
                        createUser(new User(dept_name,phoneNumberInPrefs, phoneNumberInPrefs, getString(R.string.app_name), "",false,false,reg_user_name,organization_name));
                    }
